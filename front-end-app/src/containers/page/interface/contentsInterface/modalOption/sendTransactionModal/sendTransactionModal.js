...
export const SendTransactionModal = (props) => {
  ...
  const handleSendTransaction = async () => {
    ...
    const receive = transaction.receive.substring(
      2,
      transaction.receive.length
    );

    const newTx = blockchain.generateTransaction(
      pubKey,
      receive,
      transaction.amount,
      priKey
    ...
    // axios
    //   .post(`http://localhost:${PORT}/transactions`, newTx)
    //   .then((res) => {
    //     console.log(res);
    //     props.setupModal(enumState.CLOSE);
    //     setTimeout(() => {
        ...
        <div className="content">
          <div className="transaction">
            ...
            <div className="transaction-icon">
              <i
                class="fa fa-angle-double-right fa-3x transaction-icon__icon-1"
                aria-hidden="true"
              ></i>
              <i
                class="fa fa-angle-double-right fa-3x transaction-icon__icon-2"
                aria-hidden="true"
              ></i>
              <i
                class="fa fa-angle-double-right fa-3x transaction-icon__icon-3"
                aria-hidden="true"
              ></i>
            </div>
        ...
        <div className="modal-block">
          <div className="status-modal">
            ...
            <h5 className="status-modal__desc">
              You have sent your transaction successfully.
            </h5>
          </div>
