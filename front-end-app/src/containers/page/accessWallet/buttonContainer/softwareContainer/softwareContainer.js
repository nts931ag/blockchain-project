  ...
  const handleModal = () => {
    ...
    setTimeout(() => {
      props.setCurrentModal({
        ...optionSelect,
        number: 30 + parseInt(optionSelect.number),
      });
    ...
    <div className="software-container">
      <div className="content-container">
        <div className="btn-option">
          ...
          >
            <div className="wallet-option__image">
              <img src="https://www.myetherwallet.com/img/icon-mnemonic.7c3d34fc.svg"></img>
            </div>
            <p className="wallet-option__name">Private key</p>
            <i
              className="fa fa-check-circle fa-2x wallet-option__icon"
              aria-hidden="true"
            ></i>
          </div>
        </div>
